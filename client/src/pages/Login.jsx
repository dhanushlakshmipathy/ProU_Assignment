            ...
            <div className="max-w-md w-full space-y-8 bg-white dark:bg-dark-bg p-8 rounded-xl shadow-lg border border-gray-200 dark:border-dark-border transition-colors duration-200">
                <div className="text-center">
                    <div className="mx-auto h-12 w-12 bg-indigo-100 dark:bg-dark-border flex items-center justify-center rounded-full">
                        <LogIn className="h-6 w-6 text-indigo-600 dark:text-dark-text-primary" />
                    </div>
                    <h2 className="mt-6 text-3xl font-extrabold text-gray-900 dark:text-dark-text-primary">Sign in to your account</h2>
                    <p className="mt-2 text-sm text-gray-600 dark:text-dark-text-secondary">
                        Or{' '}
                        <Link to="/signup" className="font-medium text-indigo-600 dark:text-dark-text-primary hover:text-indigo-500 dark:hover:text-dark-text-primary/80">
